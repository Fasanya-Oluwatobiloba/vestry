        ...
        <div className="space-y-6">
          ...
          <AnimateOnScroll delay={0.5}>
            <p className="text-lg text-gray-600">
              A platform provides entrepreneurs with the essential tools,
              resources, and guidance needed to launch, grow, and scale with
              confidence.
            </p>
          </AnimateOnScroll>
          <AnimateOnScroll delay={0.2}>
            <div className="flex gap-4">
              <Button
                variant="default"
                className="animate-slide-up transition-all duration-500 hover:bg-white hover:text-black"
              >
                Lets get started
              </Button>
              <Button
        ...
        <AnimateOnScroll delay={0.5}>
          <div className="relative">
            ...
            <div className="absolute bottom-4 left-4 bg-white p-4 rounded-md shadow-md max-w-xs text-sm">
              <p>
                Vestry gave me the confidence and tools to turn my side hustle
                into a full-time business. Community support was exactly what I
                needed.
              </p>
              <p className="mt-2 text-gray-500">
                Emily R., Founder of Bloom 🌿🚀
              </p>
            </div>
          </div>
        </AnimateOnScroll>

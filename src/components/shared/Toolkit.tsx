...
const features = [
  {
    ...
    description:
      "From planning to scaling, we offer everything you need in one place.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Get insights into securing investments and managing business finances.",
  },
];
        ...
        <div>
          ...
          <AnimateOnScroll delay={0.2}>
            <p className="text-gray-600 text-lg mb-8">
              Our platform offers expert guidance, financial insights, marketing
              strategies, and a strong community to help founders navigate every
          ...
          <div className="lg:space-y-10 space-y-5">
            {features.map((feature, i) => (
              <div key={i} className="border-b lg:pb-8 pb-4">
                <AnimateOnScroll key={i} delay={0.2}>
                  <h4 className="md:text-xl mb-1 text-2xl font-semibold text-gray-500">
                    {feature.title}
                  </h4>
          ...
          <AnimateOnScroll delay={0.2}>
            <Button className="mt-6 py-4 px-8" variant="default">
              Lets get started
            </Button>
          </AnimateOnScroll>
        </div>
        ...
        <div className="relative rounded-xl overflow-hidden shadow-lg lg:w-[460px] xl:w-[520px]">
          <AnimateOnScroll delay={0.2}>
            ...
            <div className="bg-black/60 text-white p-4 text-sm flex items-center gap-2">
              ...
              Our platform equips entrepreneurs with the tools, knowledge, and
              resources to build and scale successfully.
            </div>
          </AnimateOnScroll>
        </div>
      </div>
